...
\begin{figure}[H]
  ...
  \begin{subfigure}[b]{0.85\linewidth}
    ...
    \caption{3 Random strategies with optimistic Tit-for-Tat ($\text{TFT}_{DC}$)}
    \label{fig:tft_dc}
  \end{subfigure}
  ...
  \begin{subfigure}[b]{0.85\linewidth}
    ...
    \caption{3 Random strategies with defensive Tit-for-Tat ($\text{TFT}_{DD}$)}
    \label{fig:tft_dd}
  \end{subfigure}
  ...
  \begin{subfigure}[b]{0.85\linewidth}
    \centering
    \includegraphics[width=\linewidth]{images/pure_tft_cooperative_start.png}
    \caption{All start optimistic Tit-for-Tat ($\text{TFT}_{FC}$)}
    \label{fig:tft_fc}
  \end{subfigure}
  ...
  \begin{subfigure}[b]{0.85\linewidth}
    \centering
    \includegraphics[width=\linewidth]{images/pure_tft_defensive_start.png}
    \caption{All start defensive Tit-for-Tat ($\text{TFT}_{FD}$)}
    \label{fig:tft_fd}
  ...
  \begin{subfigure}[b]{0.85\linewidth}
    ...
    \caption{All start random Tit-for-Tat ($\text{TFT}_{FR}$)}
    \label{fig:tft_fr}
  \end{subfigure}
...
Given the pseudo-random background noise ($\sigma$), the convergence toward a Central Limit Gaussian distribution $\mathcal{N}(\mu, \sigma^2)$ is a expected statistical property. However, the non-trivial observation lies in how reactive strategies are contained by this stochastic noise floor:
\begin{equation}
