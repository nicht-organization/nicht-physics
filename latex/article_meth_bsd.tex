...
\section{The $L$-Series as an Aperture Meter at $s=1$}
...
\begin{equation}
\text{ord}_{s=1} L(E, s) \equiv \text{rank}(E(\mathbb{Q}))
\end{equation}
...
\lstinputlisting[language=Python, caption={Executable pytest suite \texttt{test\_bsd.py}}, basicstyle=\ttfamily\small, breaklines=true]{src/test_bsd.py}
